        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    Description = table.Column<string>(maxLength: 256, nullable: true),
                    IconPath = table.Column<string>(maxLength: 256, nullable: false),
                    AccountId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MoneyTypes_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebtId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoneyTypeId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Outcomes_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Outcomes_Bills_BillId",
                        column: x => x.BillId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Outcomes_MoneyTypes_MoneyTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvidedId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Incomes_MoneyTypes_MoneyTypeId",
                        column: x => x.MoneyTypeId,
                        principalTable: "MoneyTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Incomes_Providers_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incomes_MoneyTypeId",
                table: "Incomes",
                column: "MoneyTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_ProviderId",
                table: "Incomes",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_MoneyTypes_AccountId",
                table: "MoneyTypes",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Outcomes_AccountId",
                table: "Outcomes",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Outcomes_BillId",
                table: "Outcomes",
                column: "BillId");
